    ...
    <div className="my-16">
      ...
      <div className="m-auto w-4/5 mt-16">
        <div className="flex flex-wrap lg:flex-nowrap justify-between gap-8">
          {/**card1**/}
          <div className="card  flex-1 p-0 shadow-xl rounded-t-xl">
            <div className="h-[4rem] w-full bg-orange-400 rounded-t-xl "></div>
          ...
          <div className="card flex-1 p-0 shadow-xl rounded-t-xl">
            <div className="h-[4rem] w-full bg-[#ABA6A2] rounded-t-xl "></div>

            <div className="card-body text-left">
              <h2 className="card-title text-[#146B1E]">
                Set up your profile:{" "}
              </h2>
              <p>
          ...
          <div className="card flex-1 p-0 shadow-xl rounded-t-xl">
            <div className="h-[4rem] w-full bg-[#5AC96C] rounded-t-xl "></div>
            ...
            <div className="card-body text-left">
              ...
              <p>
                Sell your have that people might need, and create listings that
                describe your services in detail. You can set your own prices,
                and offer different packages or add-ons to make your services
                more attractive.
              </p>
            </div>
          </div>
