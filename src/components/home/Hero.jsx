...
const Hero = () => {
  return (
    ...
    <div className="  hero-content flex-col lg:flex-row-reverse px-16">
      <img src={ginny} className="max-w-48  sm:w-72 sm:shadow-none md:w-3/5 rounded-lg shadow-2xl" />
      <div className="flex flex-col text-left sm:justify-center  lg:w-2/5"> 
        ...
        <p className="py-6 md:text-xl lg:font-bold ">No more surfing  through numerous platforms or struggling to identify <br/>the perfect professional.</p>
